  ...
  const resultSearchAlbums: IAlbums[] = albums.filter((el) =>
    ...
    return (
        <Box
            ...
            bg={{base: isHomePage ? "black" : "none", sm: "none"}}
            zIndex="8"
            top="0"
            left="0"
            right="0"
            px={{base: "20px", sm: "20px", md: "45px"}}
            pt={{base: isHomePage ? "0" : "40px", sm: "40px", md: "40px"}}
        >
            {getAccessToken() ? (
                        ...
                        {!isHomePage ? (
                            ...
                            >
                                <InputLeftElement
                                    pointerEvents="none"
                                    children={
                                    <Box className={searchChange ? "" : "search"}>
                                        <SvgSearch/>
                                    </Box>
                                    }
                                />
