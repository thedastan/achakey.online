import {Box, Button, Center, Container, Divider, Image, Text} from "@chakra-ui/react";
...
export const OrderPopup = ({
    ...
    return (
        <Box
            ...
            alignItems="center"
            style={{background: openPopup ? "rgba(0, 0, 0, 0.82)" : "", inset:"0"}}
        >
            <Box w="100%" mt="94px">
                <Box
                    bg="#E0E0E0"
                ...
                >
                    <Container maxW="688px" pb="34px" >
                        <Box pos="relative">
                            <Box display={{base:"block",sm:"none"}} onClick={handleClickClose} my="10px" pos="absolute"
                                 top="0" left="40%" w="92px" h="6px"
                                 borderRadius="11px" bg="rgba(146, 146, 146, 1);"/>
