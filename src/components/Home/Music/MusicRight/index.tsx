...
import {Box, Button, Container, Flex, Stack, Text, useBreakpointValue, useDisclosure} from "@chakra-ui/react";
...
import {currentIndexAction, eventChange} from "../../../playlist/reducer/action-creator";
...
const MusicRight = ({el, index}:IMusicRight) => {
                    ...
                    <Stack direction="row" spacing={4} align="center">
                        {!getAccessToken() ? (
                            ...
                            <Button
                                ...
                                className="music--button"
                            >
                                В корзину {!el?.music?.album ?
                                <Box px="5px" color="#49DEFF" fontFamily="sans"
                                     fontSize="14px"> {Math.floor(el.music.price) + " сом"}</Box> : ""}
                            </Button>
                        )}
                        <Link
                            to={
