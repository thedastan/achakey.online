import {Box, Button, Container, Stack, Text, Spinner, ModalOverlay, useDisclosure} from "@chakra-ui/react";
            ...
            >
                {!loader ? (
                    <Container maxW="1220px" position="relative">
                        ...
                        <Box pl={{base: "0", md: "5%", xl: "0"}}>
                            ...
                            {lengthBasket[0]?.cart_item?.length && (
                                <Box
                                    ...
                                    mt="30px"
                                >
                                    <Text fontFamily="Roboto,sans-serif" fontWeight="500" my="20px" color="white">
                                        Итого: {total} cом
                                    </Text>
                                    <Button
                                        onClick={() => {
                        ...
                        <OrderPopup overlay={overlay} closeModal1={closeModal1} isOpen1={isOpen1} className={openOrder ? "modal-content" : ""} />
                        <OrderDetails overlay={overlay} closeModal2={closeModal2} isOpen2={isOpen2} className={openOrderId ? "modal-content" : ""} />
                    </Container>
                ) : (
